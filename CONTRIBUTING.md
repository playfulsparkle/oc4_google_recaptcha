...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_google_recaptcha/issues) to avoid duplicates.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_google_recaptcha/issues)
