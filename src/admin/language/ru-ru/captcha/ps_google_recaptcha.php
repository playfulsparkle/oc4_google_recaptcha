...
$_['text_captcha_page_admin_login']                = 'Вход в административную панель';
$_['text_captcha_page_catalog_login']              = 'Вход на сайт';
$_['text_captcha_page_register']                   = 'Регистрация';
$_['text_captcha_page_forgotten_password']         = 'Забытый пароль';
$_['text_captcha_page_guest']                      = 'Покупка как гость';
$_['text_captcha_page_review']                     = 'Отзывы';
$_['text_captcha_page_comment']                    = 'Комментарий';
